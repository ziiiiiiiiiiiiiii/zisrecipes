# zisrecipes
A simple HTML/CSS website of my family's recipes. Includes an index page with recipe cards that link to all the recipes on separate pages. This project is also used to practice Git workflows, feature branches, pull requests, and GitHub Actions CI.
